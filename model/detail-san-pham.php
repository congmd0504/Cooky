...
function update_chi_tiet_san_pham($id_chi_tiet_san_pham, $so_luong, $id_size, $id_do_an_them) {
    // Sửa câu lệnh SQL để đúng cú pháp
    $sql = "UPDATE chi_tiet_san_pham SET so_luong = ?, id_size = ?, id_do_an_them = ? WHERE id_chi_tiet_san_pham = ?";
    pdo_execute($sql, $so_luong, $id_size, $id_do_an_them, $id_chi_tiet_san_pham);
}
